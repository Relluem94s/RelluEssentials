...
class GameModeCreativeTest {
  ...
  @BeforeEach
  void setUp() {
    gameModeCreative = new GameModeCreative();
    gameModeCreative.injectContext(serviceContext);
  ...
  @Test
  void onCommandSetsTargetCreativeWhenOneArgAndTargetExists() {
  ...
  @Test
  void onCommandSetsSelfCreativeWhenNoArgsAndSenderIsPlayer() {
