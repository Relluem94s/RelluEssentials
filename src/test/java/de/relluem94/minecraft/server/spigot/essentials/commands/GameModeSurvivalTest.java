...
class GameModeSurvivalTest {
  ...
  @BeforeEach
  void setUp() {
    gameModeSurvival = new GameModeSurvival();
    gameModeSurvival.injectContext(serviceContext);
  ...
  @Test
  void onCommandSetsTargetSurvivalWhenOneArgAndTargetExists() {
  ...
  @Test
  void onCommandSetsSelfSurvivalWhenNoArgsAndSenderIsPlayer() {
