...
public class Strings {
    ...
    public static final String PLUGIN_COMMAND_RELLU_OPTIONS = PLUGIN_PREFIX + PLUGIN_SPACER + PLUGIN_COMMAND_COLOR + "Nutze: " + PLUGIN_COMMAND_ARG_COLOR + "save" + PLUGIN_COMMAND_COLOR + ", " + PLUGIN_COMMAND_ARG_COLOR + "reload";
    ...
    public static final String PLUGIN_EVENT_DEATH = PLUGIN_PREFIX + PLUGIN_SPACER + PLUGIN_COMMAND_COLOR + "Du stabst bei " + PLUGIN_COMMAND_ARG_COLOR + " %s";
    ...
    public static final String PLUGIN_EVENT_MOTD = "§6powered by " + PLUGIN_PREFIX;
    public static final int PLUGIN_EVENT_MOTD_MAXPLAYERS = 94;
