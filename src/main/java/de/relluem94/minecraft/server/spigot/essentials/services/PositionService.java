...
public class PositionService {
  ...
  public void tickHighlights() {
    ...
    for (Map.Entry<Player, DoubleStore<Location, Location>> entry : positionRegistry.getAll().entrySet()) {
  ...
  private void highlightPositionsForPlayer(Player player, Location firstLocation, Location secondLocation) {
    if (firstLocation != null && secondLocation != null) {
