...
public class ItemRegistry {
    ...
    public static void register(@NonNull Plugin plugin, @NonNull String itemId, @NonNull ItemHelper item) {
    ...
    private static void ensureInitialized() {
        if (persistentDataKey == null) {
            throw new IllegalStateException("ItemRegistry has not been initialized. Call ItemRegistry.initialize(plugin) first.");
        }
    }
    ...
    public static Optional<RegistryKey> identifyFromItemStack(@NonNull ItemStack itemStack) {
        ...
        String rawKey = meta.getPersistentDataContainer().get(persistentDataKey, PersistentDataType.STRING);
