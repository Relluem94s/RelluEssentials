...
public class EnchantmentManager implements Enable {
  ...
  public void enable(Plugin plugin) {
    ...
    EnchantmentService enchantmentService = relluEssentialsPlugin.getServiceContext()
        .getEnchantmentService();

    enchantmentService.register(relluEssentialsPlugin,
        EnchantmentConstants.PLUGIN_ENCHANTMENT_SCAVENGERS, new EnchantmentHelper(
            ...
            EnchantmentTarget.WEAPON, new EnchantLevel(1, 1),
            EnchantmentConstants.PLUGIN_ENCHANTMENT_SCAVENGERS_LORE, Rarity.EPIC,
            AttributeHelper.addAttribute(), 50000));

    enchantmentService.register(relluEssentialsPlugin,
        EnchantmentConstants.PLUGIN_ENCHANTMENT_LIFESTEAL, new EnchantmentHelper(
            ...
            EnchantmentTarget.WEAPON, new EnchantLevel(1, 1),
            EnchantmentConstants.PLUGIN_ENCHANTMENT_LIFESTEAL_LORE, Rarity.RARE,
            AttributeHelper.addAttribute(), 25000));

    enchantmentService.register(relluEssentialsPlugin,
        EnchantmentConstants.PLUGIN_ENCHANTMENT_AUTOSMELT, new EnchantmentHelper(
            ...
            EnchantmentTarget.TOOL, new EnchantLevel(1, 1),
            EnchantmentConstants.PLUGIN_ENCHANTMENT_AUTOSMELT_LORE, Rarity.LEGENDARY,
            AttributeHelper.addAttribute(), 250000));

    enchantmentService.register(relluEssentialsPlugin,
        EnchantmentConstants.PLUGIN_ENCHANTMENT_TELEKINESIS, new EnchantmentHelper(
            ...
            EnchantmentTarget.BREAKABLE, new EnchantLevel(1, 1),
            EnchantmentConstants.PLUGIN_ENCHANTMENT_TELEKINESIS_LORE, Rarity.LEGENDARY,
            AttributeHelper.addAttribute(), 250000));

    enchantmentService.register(relluEssentialsPlugin,
        EnchantmentConstants.PLUGIN_ENCHANTMENT_REPLENISHMENT, new EnchantmentHelper(
            ...
            EnchantmentTarget.TOOL, new EnchantLevel(1, 1),
            EnchantmentConstants.PLUGIN_ENCHANTMENT_REPLENISHMENT_LORE, Rarity.LEGENDARY,
            AttributeHelper.addAttribute(), 250000));

    enchantmentService.register(relluEssentialsPlugin,
        EnchantmentConstants.PLUGIN_ENCHANTMENT_DELICATE, new EnchantmentHelper(
            ...
            EnchantmentTarget.TOOL, new EnchantLevel(1, 1),
            EnchantmentConstants.PLUGIN_ENCHANTMENT_DELICATE_LORE, Rarity.LEGENDARY,
            AttributeHelper.addAttribute(), 250000));

    enchantmentService.register(relluEssentialsPlugin,
        EnchantmentConstants.PLUGIN_ENCHANTMENT_THUNDERSTRIKE, new EnchantmentHelper(
            ...
            EnchantmentTarget.WEAPON, new EnchantLevel(1, 1),
            EnchantmentConstants.PLUGIN_ENCHANTMENT_THUNDERSTRIKE_LORE, Rarity.LEGENDARY,
            AttributeHelper.addAttribute(Attribute.ATTACK_DAMAGE, Operation.ADD_NUMBER,
                EquipmentSlotGroup.HAND, EnchantmentConstants.PLUGIN_ENCHANTMENT_THUNDERSTRIKE, 50),
            1500000));
    ...
    consoleSendMessage(PLUGIN_NAME_CONSOLE,
        translationService.get(MessageKey.PLUGIN_MANAGER_ENCHANTMENTS_REGISTERED,
            relluEssentialsPlugin.getServiceContext().getEnchantmentService().count()));
  }
}