      ...
      public void run() {
        ...
        for (Map.Entry<Player, DoubleStore<Location, Location>> entry : relluEssentialsPlugin.position.entrySet()) {
          ...
          if (firstLocation != null && secondLocation != null) {
            ...
            drawBoxEdges(p, w, firstLocation.getX(), firstLocation.getY(), firstLocation.getZ(),
                firstLocation.getX() + 1, firstLocation.getY() + 1, firstLocation.getZ() + 1);
          } else if (secondLocation != null) {
            drawBoxEdges(p, w, secondLocation.getX(), secondLocation.getY(), secondLocation.getZ(),
                secondLocation.getX() + 1, secondLocation.getY() + 1, secondLocation.getZ() + 1);
          }
        }
