...
public class WallCommand implements SubCommand {
    ...
    public WallCommand(int blocksPerTick, SelectionResolver selectionResolver, UndoHistoryManager undoHistoryManager) {
    ...
    public void execute(Player player, String[] args) {
        ...
        player.sendMessage(languageHelper.getWithPrefix(MessageKey.COMMAND_MODIFY_WALL_STARTED, history.size(), material.name()));
    }
