...
public class PermissionsGroup implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (isPlayer(sender)) {
            ...
            p.sendMessage(String.format(PLUGIN_COMMAND_SETGROUP, g.getPrefix() + g.getName(), target.getDisplayName()));
            ...
            sender.sendMessage(String.format(PLUGIN_COMMAND_SETGROUP, g.getPrefix() + g.getName(), target.getDisplayName()));
            PlayerHelper.updateGroup(target, g);
            return true;
        }
        return false;
