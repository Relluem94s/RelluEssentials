...
public class TeleportHelper {
  ...
  private static void addBackPointAndTeleport(String message, Player p, World world, boolean silent,
  ...
  private static void addBackPointAndTeleport(String message, Player p, World world, boolean silent,
    ...
    Location locationWorld = new Location(world, location.getX(), location.getY(), location.getZ(),
