...
import de.relluem94.minecraft.server.spigot.essentials.commands.modify.ClipboardCommand;
import de.relluem94.minecraft.server.spigot.essentials.commands.modify.CopyCommand;
import de.relluem94.minecraft.server.spigot.essentials.commands.modify.CylinderCommand;
import de.relluem94.minecraft.server.spigot.essentials.commands.modify.FillCommand;
import de.relluem94.minecraft.server.spigot.essentials.commands.modify.MoveCommand;
import de.relluem94.minecraft.server.spigot.essentials.commands.modify.PasteCommand;
import de.relluem94.minecraft.server.spigot.essentials.commands.modify.PlantCommand;
import de.relluem94.minecraft.server.spigot.essentials.commands.modify.ReplaceCommand;
...
public class Modify implements CommandConstruct {
  ...
  public void injectContext(ServiceContext context) {
    ...
    this.subCommandRegistry = new SubCommandRegistry<>(List.of(
        ...
        new FillCommand(false, BLOCKS_PER_TICK, MAX_RADIUS, MAX_ITERATIONS, undoHistoryService),
        new FillCommand(true, BLOCKS_PER_TICK, MAX_RADIUS, MAX_ITERATIONS, undoHistoryService),
