...
public interface Constants {
    ...
    String PLUGIN_COOMAND_MODIFY_UNDO_STARTED = PLUGIN_FORMS_COMMAND_PREFIX + "Undo was started!";
    ...
    String PLUGIN_COOMAND_MODIFY_SET_STARTED = PLUGIN_FORMS_COMMAND_PREFIX + "Set %s was started!";
    String PLUGIN_COOMAND_MODIFY_REPLACE_STARTED = PLUGIN_FORMS_COMMAND_PREFIX + "Replace %s with %s was started!";
