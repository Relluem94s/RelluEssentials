...
public interface Constants {
    ...
    String PLUGIN_COMMAND_POSITION_INFO_NO_POSITIONS = PLUGIN_FORMS_COMMAND_PREFIX + "No Positions set";
    String PLUGIN_COMMAND_POSITION_CLEAR = PLUGIN_FORMS_COMMAND_PREFIX + "Positions Cleared";
    String PLUGIN_COMMAND_POSITION_SET_FIRST = PLUGIN_FORMS_COMMAND_PREFIX + "#1 Position was set to %s";
    String PLUGIN_COMMAND_POSITION_SET_SECOND = PLUGIN_FORMS_COMMAND_PREFIX + "#2 Position was set to %s";
    String PLUGIN_COMMAND_POSITION_REMOVE_FIRST = PLUGIN_FORMS_COMMAND_PREFIX + "#1 Position was removed";
    String PLUGIN_COMMAND_POSITION_REMOVE_SECOND = PLUGIN_FORMS_COMMAND_PREFIX + "#2 Position was removed";
    String PLUGIN_COMMAND_POSITION_INVALID_AMOUNT = PLUGIN_FORMS_COMMAND_PREFIX + "Invalid Amount";
    String PLUGIN_COMMAND_POSITION_SHIFT = PLUGIN_FORMS_COMMAND_PREFIX + "Positions shifted %s blocks";
    String PLUGIN_COMMAND_POSITION_NEED_BOTH_POSITIONS = PLUGIN_FORMS_COMMAND_PREFIX + "Need both Positions";
    String PLUGIN_COMMAND_POSITION_EXPAND = PLUGIN_FORMS_COMMAND_PREFIX + "Expanded the Position";
    String PLUGIN_COMMAND_POSITION_DECREASE = PLUGIN_FORMS_COMMAND_PREFIX + "Decreased the Position";
    ...
    String PLUGIN_COMMAND_MODIFY_UNDO_STARTED = PLUGIN_FORMS_COMMAND_PREFIX + "Undo of " + PLUGIN_COLOR_COMMAND_ARG + "%d" + PLUGIN_COLOR_MESSAGE + " blocks was started!";
    ...
    String PLUGIN_COMMAND_MODIFY_SET_STARTED = PLUGIN_FORMS_COMMAND_PREFIX + "Set of " + PLUGIN_COLOR_COMMAND_ARG + "%d" + PLUGIN_COLOR_MESSAGE + " blocks with material " + PLUGIN_COLOR_COMMAND_ARG + "%s" + PLUGIN_COLOR_MESSAGE + " was started!";
    String PLUGIN_COMMAND_MODIFY_MOVE_STARTED = PLUGIN_FORMS_COMMAND_PREFIX + "Move of " + PLUGIN_COLOR_COMMAND_ARG + "%d" + PLUGIN_COLOR_MESSAGE + " blocks with offset " + PLUGIN_COLOR_COMMAND_ARG + "%d" + PLUGIN_COLOR_MESSAGE + " was started!";
    String PLUGIN_COMMAND_MODIFY_REPLACE_STARTED = PLUGIN_FORMS_COMMAND_PREFIX + "Replace of " + PLUGIN_COLOR_COMMAND_ARG + "%d" + PLUGIN_COLOR_MESSAGE + " blocks with material " + PLUGIN_COLOR_COMMAND_ARG + "%s" + PLUGIN_COLOR_MESSAGE + " to " + PLUGIN_COLOR_COMMAND_ARG + "%s" + PLUGIN_COLOR_MESSAGE + " was started!";
    String PLUGIN_COMMAND_MODIFY_COPY_STARTED = PLUGIN_FORMS_COMMAND_PREFIX + "Copied " + PLUGIN_COLOR_COMMAND_ARG + "%d" + PLUGIN_COLOR_MESSAGE + " blocks to clipboard.";
    String PLUGIN_COMMAND_MODIFY_CUT_STARTED = PLUGIN_FORMS_COMMAND_PREFIX + "Cut " + PLUGIN_COLOR_COMMAND_ARG + "%d" + PLUGIN_COLOR_MESSAGE + " blocks to clipboard.";
    String PLUGIN_COMMAND_MODIFY_PASTE_STARTED = PLUGIN_FORMS_COMMAND_PREFIX + "Pasted " + PLUGIN_COLOR_COMMAND_ARG + "%d" + PLUGIN_COLOR_MESSAGE + " blocks from clipboard.";
    String PLUGIN_COMMAND_MODIFY_NO_CLIPBOARD = PLUGIN_FORMS_COMMAND_PREFIX + "Clipboard is empty.";
    String PLUGIN_COMMAND_MODIFY_WALL_STARTED = PLUGIN_FORMS_COMMAND_PREFIX + "Created wall with " + PLUGIN_COLOR_COMMAND_ARG + "%d" + PLUGIN_COLOR_MESSAGE + " blocks of " + PLUGIN_COLOR_COMMAND_ARG + "%s" + PLUGIN_COLOR_MESSAGE + ".";
    String PLUGIN_COMMAND_MODIFY_CYLINDER_STARTED = PLUGIN_FORMS_COMMAND_PREFIX + "Created cylinder with " + PLUGIN_COLOR_COMMAND_ARG + "%d" + PLUGIN_COLOR_MESSAGE + " blocks of " + PLUGIN_COLOR_COMMAND_ARG + "%s" + PLUGIN_COLOR_MESSAGE + ".";
    String PLUGIN_COMMAND_MODIFY_FILL_STARTED = PLUGIN_FORMS_COMMAND_PREFIX + "Filled " + PLUGIN_COLOR_COMMAND_ARG + "%d" + PLUGIN_COLOR_MESSAGE + " blocks of " + PLUGIN_COLOR_COMMAND_ARG + "%s " + PLUGIN_COLOR_MESSAGE + "in a radius of " + PLUGIN_COLOR_COMMAND_ARG + "%d" + PLUGIN_COLOR_MESSAGE + ".";
    String PLUGIN_COMMAND_MODIFY_FILLR_STARTED = PLUGIN_FORMS_COMMAND_PREFIX + "Filled " + PLUGIN_COLOR_COMMAND_ARG + "%d" + PLUGIN_COLOR_MESSAGE + " blocks of " + PLUGIN_COLOR_COMMAND_ARG + "%s " + PLUGIN_COLOR_MESSAGE + "downwards in a radius of " + PLUGIN_COLOR_COMMAND_ARG + "%d" + PLUGIN_COLOR_MESSAGE + ".";
    String PLUGIN_COMMAND_MODIFY_FILL_RADIUS_TO_HIGH = PLUGIN_FORMS_COMMAND_PREFIX + "Can't fill Radius is to High! Max Radius is " + PLUGIN_COLOR_COMMAND_ARG + "%d" + PLUGIN_COLOR_MESSAGE + ".";
    String PLUGIN_COMMAND_MODIFY_CLIPBOARD_ROTATE_SUCCESS = PLUGIN_FORMS_COMMAND_PREFIX + "Clipboard rotated 90° successfully!";
    String PLUGIN_COMMAND_MODIFY_PLANT_STARTED = PLUGIN_FORMS_COMMAND_PREFIX + "Planting " + PLUGIN_COLOR_COMMAND_ARG + "%d" + PLUGIN_COLOR_MESSAGE + " blocks of " + PLUGIN_COLOR_COMMAND_ARG + "%s" + PLUGIN_COLOR_MESSAGE + "...";
