...
public class DatabaseMappings {
  ...
  public static final String FIELD_LOCATION_FK = "location_fk";
  ...
  public static final String FIELD_MIN_INT = "min_int";
  public static final String FIELD_MAX_INT = "max_int";
  public static final String FIELD_SETTING_FK = "setting_fk";
  public static final String FIELD_WORLD_GORUP_FK = "world_group_fk";
  public static final String FIELD_PROFILE_NAME = "profile_name";
  public static final String FIELD_LIST_POSITION = "listPosition";
  public static final String FIELD_TEXT = "text";
  public static final String FIELD_CUSTOM_NPC_FK = "custom_npc_fk";
}