...
public class WorldHelper {
   ...
   * @param worldName String
   * @param save      boolean
   * @throws de.relluem94.minecraft.server.spigot.essentials.exceptions.WorldNotLoadedException if
   *                                                                                            World
   *                                                                                            is
   *                                                                                            not
   *                                                                                            loaded
  ...
  public static void unloadWorld(String worldName, boolean save) throws WorldNotLoadedException {
    if (Bukkit.getWorld(worldName) != null) {
      ...
      throw new WorldNotLoadedException(
          String.format(PLUGIN_EXCEPTION_WORLD_NOT_LOADED, worldName));
    }
  }
   ...
   * @throws de.relluem94.minecraft.server.spigot.essentials.exceptions.WorldNotFoundException if
   *                                                                                           World
   *                                                                                           was
   *                                                                                           not
   *                                                                                           found
