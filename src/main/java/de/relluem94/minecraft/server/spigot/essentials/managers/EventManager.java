...
public class EventManager implements IEnable{
    ...
    public void enable() {
        ...
        pm.registerEvents(new BlockBreakBags(), RelluEssentials.getInstance());             eventCount++;
        pm.registerEvents(new BlockDropItemBags(), RelluEssentials.getInstance());          eventCount++;
        pm.registerEvents(new InventoryClickBags(), RelluEssentials.getInstance());         eventCount++;
        pm.registerEvents(new EntityPickupItemBags(), RelluEssentials.getInstance());       eventCount++;
