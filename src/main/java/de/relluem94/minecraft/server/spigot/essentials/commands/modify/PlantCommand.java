...
public class PlantCommand implements SubCommand {
    ...
    public PlantCommand(int blocksPerTick, SelectionResolver selectionResolver, UndoHistoryManager undoHistoryManager) {
    ...
    public void execute(Player player, String[] args) {
        ...
        forEachBlock(selection, block -> {
            ...
            if (material.equals(block.getType())) return;
        ...
        player.sendMessage(languageHelper.getWithPrefix(MessageKey.COMMAND_MODIFY_PLANT_STARTED, history.size(), material.name()));
    }
