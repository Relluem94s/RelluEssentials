...
public class SignActions implements Listener {
    ...
    public void onChangeSignCreateActionSign(SignChangeEvent e) {
        if (Permission.isAuthorized(e.getPlayer(), Groups.getGroup("mod").getId())) {
            if (e.getLine(1) != null) {
                if (e.getLine(1).equals(CustomSigns.spawn.getSignActionType().getShorthand()) || e.getLine(1).equalsIgnoreCase(CustomSigns.spawn.getSignActionType().getName())) { 
                ...
                } else if (e.getLine(1).equals(CustomSigns.teleport.getSignActionType().getShorthand()) || e.getLine(1).equalsIgnoreCase(CustomSigns.teleport.getSignActionType().getName())) {
                ...
                } else if (e.getLine(1).equals(CustomSigns.home.getSignActionType().getShorthand()) || e.getLine(1).equalsIgnoreCase(CustomSigns.home.getSignActionType().getName())) {
                    e.setLine(0, CustomSigns.home.getLine1());
                    e.setLine(1, CustomSigns.home.getLine2());

                    e.setLine(3, CustomSigns.home.getLine4());
                } else if (e.getLine(1).equals(CustomSigns.up.getSignActionType().getShorthand()) || e.getLine(1).equalsIgnoreCase(CustomSigns.up.getSignActionType().getName())) {
                ...
                } else if (e.getLine(1).equals(CustomSigns.down.getSignActionType().getShorthand()) || e.getLine(1).equalsIgnoreCase(CustomSigns.down.getSignActionType().getName())) {
                ...
                } else if (e.getLine(1).equals(CustomSigns.command.getSignActionType().getShorthand()) || e.getLine(1).equalsIgnoreCase(CustomSigns.command.getSignActionType().getName())) {
