...
public enum ItemPrice {
  ...
  STRIPPED_MANGROVE_LOG(0,0),
  STRIPPED_CRIMSON_STEM(0,0),
  STRIPPED_WARPED_STEM(0,0),
  STRIPPED_OAK_WOOD(8,8),
  STRIPPED_SPRUCE_WOOD(8,8),
  STRIPPED_BIRCH_WOOD(8,8),
  STRIPPED_JUNGLE_WOOD(8,8),
  STRIPPED_ACACIA_WOOD(8,8),
  STRIPPED_DARK_OAK_WOOD(8,8),
  STRIPPED_MANGROVE_WOOD(8,8),
  STRIPPED_CRIMSON_HYPHAE(0,0),
  STRIPPED_WARPED_HYPHAE(0,0),
  STRIPPED_BAMBOO_BLOCK(0,0),
  OAK_WOOD(8,8),
  SPRUCE_WOOD(8,8),
  BIRCH_WOOD(8,8),
  JUNGLE_WOOD(8,8),
