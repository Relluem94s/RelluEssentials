...
public class CustomItems {
    ...
    public static ItemHelper coins = new ItemHelper(Material.GOLD_NUGGET, 1, PLUGIN_ITEM_COINS, Type.MONEY, Rarity.COMMON, Arrays.asList(new String[]{PLUGIN_ITEM_COINS_LORE}));
