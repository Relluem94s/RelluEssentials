...
public enum MessageKey {
  ...
  PLUGIN_MANAGER_ENCHANTMENTS_REGISTERED("plugin.manager.enchantments_registered"),
  PLUGIN_MANAGER_INVENTORIES_REGISTERED("plugin.manager.inventories_registered"),
  PLUGIN_MANAGER_SIGNS_REGISTERED("plugin.manager.signs_registered"),
  ...
  COMMAND_NPC_CREATE_USAGE("command.npc.create.usage"),
  COMMAND_NPC_DELETE_USAGE("command.npc.delete.usage"),
  COMMAND_NPC_UPDATE_USAGE("command.npc.update.usage"),
  COMMAND_NPC_CREATED("command.npc.created"),
  COMMAND_NPC_DELETED("command.npc.deleted"),
  COMMAND_NPC_UPDATED("command.npc.updated"),
  COMMAND_NPC_NOT_FOUND("command.npc.not_found"),
  COMMAND_NPC_INVALID_ID("command.npc.invalid_id"),
  COMMAND_NPC_INVALID_COORDINATES("command.npc.invalid_coordinates"),
  COMMAND_NPC_OPERATION_FAILED("command.npc.operation_failed"),
  COMMAND_NPC_DIALOGUE_ADD_USAGE("command.npc.dialogue.add.usage"),
  COMMAND_NPC_DIALOGUE_UPDATE_USAGE("command.npc.dialogue.update.usage"),
  COMMAND_NPC_DIALOGUE_DELETE_USAGE("command.npc.dialogue.delete.usage"),
  COMMAND_NPC_DIALOGUE_ADDED("command.npc.dialogue.added"),
  ...
  PLUGIN_EVENT_PROTECTED_BLOCK_INFO_PLAYER_LAST_LOGIN(
      "plugin.event.protected_block.info_player_last_login"),
  ...
  PLUGIN_EVENT_PROTECT_BLOCK_DISALLOW_ADMIN_OVERWRITE(
      "plugin.event.protect_block.disallow_admin_overwrite"),
  ...
  PLUGIN_EVENT_NPC_BANKER_DEPOSIT_NO_COINS_MESSAGE(
      "plugin.event.npc_banker.deposit_no_coins_message"),
  ...
  PLUGIN_EVENT_NPC_BANKER_OPEN_ACCOUNT_TO_LESS_COINS(
      "plugin.event.npc_banker.open_account_to_less_coins"),
