...
public class ItemConstants {
  ...
  public static final String PLUGIN_ITEM_NAMESPACE_RELLU_HELMET = "rellu_helmet";
  public static final String PLUGIN_ITEM_NAMESPACE_RELLU_CHESTPLATE = "rellu_chestplate";
  public static final String PLUGIN_ITEM_NAMESPACE_RELLU_LEGGINGS = "rellu_leggings";
  public static final String PLUGIN_ITEM_NAMESPACE_RELLU_BOOTS = "rellu_boots";
  public static final String PLUGIN_ITEM_NAMESPACE_GRAPPLINGHOOK = "grappling_hook";
  public static final String PLUGIN_ITEM_NAMESPACE_AUTOSELL_HOPPER = "autosell_hopper";
  public static final String PLUGIN_ITEM_NAMESPACE_CLOUD_BOOTS = "cloud_boots";
  public static final String PLUGIN_ITEM_NAMESPACE_MAGIC_WATER_BUCKET = "magic_water_bucket";
  public static final String PLUGIN_ITEM_NAMESPACE_COINS = "coins";
  public static final String PLUGIN_ITEM_NAMESPACE_CLOUD_SAILOR = "cloud_sailor";
  public static final String PLUGIN_ITEM_NAMESPACE_POSITION_AXE = "position_axe";
