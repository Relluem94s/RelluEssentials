...
public class SetCommand implements SubCommand {
    ...
    public SetCommand(int blocksPerTick, SelectionResolver selectionResolver, UndoHistoryManager undoHistoryManager) {
    ...
    public void execute(Player player, String[] args) {
        ...
        player.sendMessage(languageHelper.getWithPrefix(MessageKey.COMMAND_MODIFY_SET_STARTED, history.size(), material.name()));
    }
